...
test_too_old_framework_read_only_does_not_delete() {
	(
		...
		assert_contains "${CAPTURE_OUTPUT}" "requires v0.9.0+" "doctor should report minimum version requirement"
...
test_doctor_delegates_for_082_plus() {
	(
		...
		make_stub_framework_091 "${home_dir}"
