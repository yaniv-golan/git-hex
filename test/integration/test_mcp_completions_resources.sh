...
# Note: includes domain-model resource plus 3 UI resources (getRebasePlan, getConflictStatus, checkRebaseConflicts)
assert_eq  "4" "${rlist_total}" "expected 4 resources (1 domain-model + 3 ui)"
